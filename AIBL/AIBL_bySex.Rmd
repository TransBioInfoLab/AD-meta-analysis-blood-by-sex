...
3. Remove smoking related probes
...
nb.chrXY.probes.detectP.cg.dmrcate <- nrow(betaSet)
```
...
#plot_inflation(
#  data = results.ad.glm.male.with.inflation, 
#  main = "MALES AIBL AD vs CN - single cpg\n Logistic regression model"
#)
