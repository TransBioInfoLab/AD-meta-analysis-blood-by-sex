...
save(
  ...
  file = "datasets/Aux/ADNI_matched_rna_dnam_male_female.rda"
)
...
all(rownames(residuals.matched.met) == rownames(metadata.exp))
all(colnames(residuals.matched.exp) == colnames(residuals.matched.met))
...
save(
  ...
  file = "datasets/Aux/ADNI_matched_rna_dnam_residuals_bySex.rda"
)
