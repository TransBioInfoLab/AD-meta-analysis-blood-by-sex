...
results.files <- results.files[grep("FEMALE",results.files,invert = T)]
...
readr::write_csv(
  ...
  file = paste0(dir.result.meta.analysis.ad, "MALE_meta_analysis_glm_fixed_effect_ADNI_and_AIBL_AD_vs_CN_DMR.csv")
)
```
...
readr::write_csv(
  ...
  file = paste0(dir.result.meta.analysis.ad, "MALE_meta_analysis_glm_fixed_effect_ADNI_and_AIBL_AD_vs_CN_DMR_annotated.csv")
)
...
readr::write_csv(
  ...
  file = paste0(
    ...
    "MALE_meta_analysis_glm_fixed_effect_ADNI_and_AIBL_AD_vs_CN_DMR_annotated_pvalue_cut_off_0_05.csv"
  )
)
```
