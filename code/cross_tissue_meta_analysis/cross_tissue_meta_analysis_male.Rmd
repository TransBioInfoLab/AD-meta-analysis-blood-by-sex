...
blood.meta_analysis.male <- readr::read_csv(
  file.path(dir.results, 
            "meta_analysis/Logistic_regression_model/withSmokePrbs/AD_vs_CN/MALE_meta_analysis_glm_fixed_effect_ADNI_and_AIBL_AD_vs_CN_single_cpg_annotated.csv"
  )
)
...
writexl::write_xlsx(
  x = final.table,
  path = file.path(dir.result.cross.meta.analysis, "MALE_all_meta_analysis_with_Smok_probes.csv")
)
```
