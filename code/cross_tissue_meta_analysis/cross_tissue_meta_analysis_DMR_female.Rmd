...
blood.meta_analysis <- readr::read_csv(
  "~/TBL Dropbox/Tiago Silva/AD-meta-analysis-blood-samples-bySex/analysis_results/meta_analysis/DMR_Logistic_regression_model/AD_vs_CN/FEMALE_meta_analysis_glm_fixed_effect_ADNI_and_AIBL_AD_vs_CN_DMR_annotated.csv",
...
brain.meta_analysis <- readr::read_csv(
  "~/TBL Dropbox/Tiago Silva/AD_metaAnalysis_bySex/meta_analysis_region_based_results/region_based_female_meta_bacon_annot_df.csv",
  col_types = readr::cols()
)
...
meta <- plyr::adply(
  ...
  },.progress = "time",.parallel = FALSE,.expand = TRUE,.inform = T
)
...
readr::write_csv(
  meta  %>% as.data.frame(),
  file = paste0(dir.result.cross.meta.analysis, "FEMALE_cross_tissue_meta_analysis_glm_using_AD_vs_CN_DMR_all_before_filters.csv")
)

readr::write_csv(
  meta.with.blood  %>% as.data.frame(),
  file = paste0(dir.result.cross.meta.analysis, "FEMALE_cross_tissue_meta_analysis_glm_using_AD_vs_CN_DMR.csv")
)
```
...
readr::write_csv(
  ...
  file = paste0(dir.result.cross.meta.analysis, "FEMALE_cross_tissue_meta_analysis_glm_using_AD_vs_CN_DMR_annotated.csv")
)
readr::write_csv(
  meta.with.blood.annotated.sig  %>% as.data.frame(),
  file = paste0(dir.result.cross.meta.analysis, "FEMALE_cross_tissue_meta_analysis_glm_using_AD_vs_CN_DMR_annotated_fdr_0_05.csv")
)
```
