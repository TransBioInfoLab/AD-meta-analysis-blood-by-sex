...
#-------------------------------------------------------------------------------
nrow(distal.gene.dnam.pair.female) #  1360
...
nrow(distal.gene.dnam.pair.female) # 1044
...
# Save resuls
#-------------------------------------------------------------------------------
path.RNA_vs_DNAm <- "~/TBL Dropbox/Tiago Silva/AD-meta-analysis-blood-samples-bySex//analysis_results/RNA_vs_DNAm/"
writexl::write_xlsx(
  list(
    "MALE Promoter" = results.promoter.analysis.male,
    "MALE Distal_5_up_5_down" = results.distal.analysis.male,
    "FEMALE Promoter" = results.promoter.analysis.female,
    "FEMALE Distal_5_up_5_down" = results.distal.analysis.female
